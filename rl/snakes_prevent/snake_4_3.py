...
# rewards:
# 1 for eating fruit, -(# of empty squares left) for dying, 1 for winning, -0.001 for nothing
...
class Snake4(SnakeEnv):
    ...
    def step(self, action):
        ...
        if self._collision(self.snake, new, True):
            return self._get_state(), len(self.snake) - self.width*self.height, True, False, {'snake': self.snake}
